...
export function SingleCarouselMobileAnimation({
  baseVelocity = 100,
  mediaObject,
}) {
  ...
  return (
    <div className="flex w-full gap-2 my-2 overflow-hidden ">
      <motion.div className="flex w-[150vw] gap-4 " style={{ x }}>
        {mediaObject.slice(0, 3).map((media, index) => {
          return (
            <div key={index} className="w-full h-32 aspect-video">
              <img
                src={media}
                alt="media"
